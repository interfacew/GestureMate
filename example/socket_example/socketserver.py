    ...
    if '\0' in msg:
        ...
        if pack['pose']['face']!=None:
            for a in pack['pose']['face']:
                cv2.circle(image,(math.floor(a[0]*160),math.floor(a[1]*90)),1,(255,0,0),4)
        if pack['pose']['leftHand']!=None:
            for a in pack['pose']['leftHand']:
                cv2.circle(image,(math.floor(a[0]*160),math.floor(a[1]*90)),1,(0,255,0),4)
        if pack['pose']['rightHand']!=None:
            for a in pack['pose']['rightHand']:
                cv2.circle(image,(math.floor(a[0]*160),math.floor(a[1]*90)),1,(0,0,255),4)
